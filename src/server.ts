...
export class Server {
    ...
    connectMongoDB(){
        mongoose.connect('mongodb+srv://digsu:SDigvijay123@cluster0.k78bu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',{ useNewUrlParser: true,useUnifiedTopology: true })
        .then((data)=>{
